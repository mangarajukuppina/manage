...
client.addEventListener("click", ()=>{
    window.open("http://127.0.0.1:5501/front_end/images/Client/client-signin.html")
...
manager.addEventListener("click", ()=>{
    console.log("hi");
    window.open("http://127.0.0.1:5501/front_end/images/manager/manager_sign_up.html")
